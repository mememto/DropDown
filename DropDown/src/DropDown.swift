...
public final class DropDown: UIView {
	...
	*/
    @objc public dynamic var cornerRad = DPDConstant.UI.CornerRadius {
	...
	*/
    @objc public dynamic var shadowOpac = DPDConstant.UI.Shadow.Opacity {
	...
	*/
    @objc public dynamic var shadowRad = DPDConstant.UI.Shadow.Radius {
...
extension DropDown {
	...
	public override func layoutSubviews() {
		...
		let shadowPath = UIBezierPath(roundedRect: tableViewContainer.bounds, cornerRadius: cornerRad)
